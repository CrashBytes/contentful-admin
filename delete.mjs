...
export async function bulkDelete(contentType) {

 await handleBulkAction(contentType, 'delete');

}

export async function deleteSingle(entryId, environment) {

 await handleSingleAction(entryId, environment, 'delete');
